...
ALLOWED_HOSTS = [
    '.onrender.com',          # Render domeni uchun
    'ruzcoder.uz',          # O'z domeningizni yozing
    'localhost', '127.0.0.1', # Lokal test uchun
]
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # Loyihadagi umumiy templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.request',
...
# =====================================
#     XAVFSIZLIK (HTTPS uchun Render'da)
# =====================================
